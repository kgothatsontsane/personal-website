export const personalInfo = {
  ...
  bio: 'I build things that work. 7 years shipping production software across fintech, e-commerce, and enterprise — from interfaces to infrastructure, secured by design. I threat-model before I code, and build systems that scale without a rewrite or a breach. Currently focused on AI-augmented and security-hardened development, type-safe and generic architectures, and shipping faster — and safer — than the next quarterly review.',
