export const personalInfo = {
  ...
  missionCount: 7,
  specialties: 'Security, Frontend, Backend, Cloud & AI Systems',
  clearance: 'LEVEL 5',
  status: 'ACTIVE',
  phone: '076-792-2638',
  email: 'nvisionfactory@gmail.com',
  bio: 'I build things that work. 7 years shipping production software across fintech, e-commerce, and enterprise. From interfaces to infrastructure — hardened for security from the ground up. I care about systems that scale without needing a rewrite. Currently focused on AI-augmented development, security-hardened and type-safe architectures, and shipping faster than the next quarterly review.',
